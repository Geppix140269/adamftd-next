...
const plans = [
  {
    ...
    features: [
      ...
      { text: "Export contacts", included: false },
      { text: "Price benchmarking", included: false },
      { text: "Market reports", included: false },
      { text: "Tariff calculations", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Unlimited company validation", included: true },
      { text: "Export full contact details", included: true },
      { text: "Real-time price benchmarking", included: true },
      { text: "AI-generated market reports", included: true },
      { text: "Tariff & compliance tools", included: true },
